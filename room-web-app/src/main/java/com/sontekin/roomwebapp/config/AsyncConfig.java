package com.sontekin.roomwebapp.config;

import com.sontekin.roomwebapp.async.RoomCleanerListener;
...
public class AsyncConfig {
    ...
    public Binding binding(Queue queue, TopicExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with("eskisehir.rooms.cleaner");
    }
